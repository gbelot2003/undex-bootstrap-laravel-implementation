        ...
        <div class="choose-layout" id="chooseLayout">
            ...
            <div class="demos-content">
                <div class="single-demos">
                    <a href="../side-menu-dark/index.html"><img src="/images/demo/1.png" alt=""></a>
                    <span>Vertical Dark</span>
                </div>
                <div class="single-demos">
                    <a href="../side-menu/index.html"><img src="/images/demo/2.png" alt=""></a>
                    <span>Vertical Light</span>
                </div>
                <div class="single-demos">
                    <a href="../side-menu-gradient/index.html"><img src="/images/demo/3.png" alt=""></a>
    ...
    <div class="ecaps-page-wrapper">
        ...
        <div class="ecaps-sidemenu-area">
            ...
            <div class="ecaps-logo">
                <a href="index.html"><img class="desktop-logo" src="/images/core-img/logo.png" alt="Desktop Logo"> <img class="small-logo" src="/images/core-img/small-logo.png" alt="Mobile Logo"></a>
            </div>
                        ...
                        <ul class="sidebar-menu" data-widget="tree">
                            <li class="sidemenu-user-profile d-flex align-items-center">
                                <div class="user-thumbnail">
                                    <img src="/images/member-img/1.png" alt="">
                                </div>
            ...
            <header class="top-header-area d-flex align-items-center justify-content-between">
                <div class="left-side-content-area d-flex align-items-center">
                    ...
                    <div class="mobile-logo mr-3 mr-sm-4">
                        <a href="index.html"><img src="/images/core-img/small-logo.png" alt="Mobile Logo"></a>
                    </div>
                ...
                <div class="right-side-navbar d-flex align-items-center justify-content-end">
                    ...
                    <ul class="right-side-content d-flex align-items-center">
                        <li class="nav-item dropdown">
                            <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="border-radius-none" src="/images/core-img/l3.jpg" alt=""></button>
                            <div class="dropdown-menu language-dropdown dropdown-menu-right">
                                <a href="#" class="dropdown-item"><img src="/images/core-img/l1.jpg" alt=""> IND</a>
                                <a href="#" class="dropdown-item"><img src="/images/core-img/l2.jpg" alt=""> LOP</a>
                                <a href="#" class="dropdown-item"><img src="/images/core-img/l3.jpg" alt=""> KYI</a>
                                <a href="#" class="dropdown-item"><img src="/images/core-img/l4.jpg" alt=""> RTY</a>
                            </div>
                        </li>
                        <!-- Full Screen Mode -->
                        ...
                        <li class="nav-item dropdown">
                            <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img class="border-radius-50" src="/images/member-img/1.png" alt=""></button>
                            <div class="dropdown-menu dropdown-menu-right">
                                <!-- User Profile Area -->
                                <div class="user-profile-area">
                                    <div class="user-profile-heading">
                                        ...
                                        <div class="profile-thumbnail">
                                            <img class="border-radius-50" src="/images/member-img/1.png" alt="">
                                        </div>
                                        <!-- Profile Text -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card gradient-light-blue-cyan">
                                <div class="card-body center">
                                    <img src="/images/shop-img/2.png" alt="">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card gradient-45deg-red-pink border-radius-3">
                                <div class="card-body center">
                                    <img src="/images/shop-img/7.png" alt="">
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="card gradient-45deg-amber-amber border-radius-3">
                                <div class="card-body center">
                                    <img src="/images/shop-img/10.png" alt="">
                                            ...
                                            <div class="widget-timeline mb-30">
                                                <div class="media">
                                                    <div class="mr-3 photo-table">
                                                        ...
                                                        <a href="#!"><img class="rounded-circle" style="width:40px;" src="/images/member-img/1.png" alt="chat-user"></a>
                                                    </div>
                                            ...
                                            <div class="widget-timeline mb-30">
                                                <div class="media">
                                                    <div class="mr-3 photo-table">
                                                        ...
                                                        <a href="#!"><img class="rounded-circle" style="width:40px;" src="/images/member-img/2.png" alt="chat-user"></a>
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <div class="widget-timeline mb-30">
                                                <div class="media">
                                                    <div class="mr-3 photo-table">
                                                        ...
                                                        <a href="#!"><img class="rounded-circle" style="width:40px;" src="/images/member-img/3.png" alt="chat-user"></a>
                                                    </div>
                                                    <div class="media-body">
                                                        <h6 class="d-inline-block">The Quick Brown Fox</h6>
                                                        <p class="mb-0">Ipsum is simply text of…</p>
                                        ...
                                        <div class="col-12">
                                            <div class="widget-timeline mb-30">
                                                <div class="media">
                                                    <div class="mr-3 photo-table">
                                                        <i class="fa fa-circle text-green font-12 mr-2"></i>
                                                        <a href="#!"><img class="rounded-circle" style="width:40px;" src="/images/member-img/4.png" alt="chat-user"></a>
                                                    </div>
                                                    <div class="media-body">
                                                        <h6 class="d-inline-block">The Quick Brown Fox</h6>
                                                        <p class="mb-0">Ipsum is simply text of…</p>
                            ...
                            <ul>
                                <li class="clearfix mb-15">
                                    <div class="message-data text-right">
                                        <span class="mr-2"><img class="chat-img" src="/images/member-img/1.png" alt=""></span>
                                ...
                                <li class="clearfix mb-15">
                                    <div class="message-data">
                                        <span class="mr-2"><img class="chat-img" src="/images/member-img/2.png" alt=""></span>
